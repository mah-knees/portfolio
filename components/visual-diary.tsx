...
const diaryItems: DiaryItem[] = [
  ...
  },
  {
    ...
    span: "col-span-1 md:col-span-2 md:row-span-1",
    aspect: "aspect-square md:aspect-square",
  },
  {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px] px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="grid grid-cols-3 gap-0.5 sm:gap-1 md:gap-3 md:grid-cols-6">
          {diaryItems.map((item, index) => (
            ...
            >
              <Image
                ...
                className="object-cover transition duration-500 ease-out [@media(hover:hover)]:group-hover:scale-[1.02] [@media(hover:hover)]:group-hover:brightness-110"
              />
            </motion.div>
          ))}
        </div>
